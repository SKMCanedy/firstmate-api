...
router.post("/", jsonParser, (req, res) => {
    ...
    const userSchema = {
        ...
        username: Joi.string().min(3).regex(/^[A-Za-z0-9_]+$/).required(), //no special characters
        password: Joi.string().min(7).max(72).regex(/^[A-Za-z0-9_!@$]+$/).required()//allows _ ! @ $ as special characters
};
